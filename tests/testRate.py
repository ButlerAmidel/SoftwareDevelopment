...
from my_Rate import RateUtility, CompoundingFrequency, DayCountConvention
...
class TestEquivalentRate(unittest.TestCase):
    ...
    def test_equivalentRate(self):
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACA, DayCountConvention.ACT_360,
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACS, DayCountConvention.ACT_360,
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACM, DayCountConvention.ACT_360,
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACD, DayCountConvention.ACT_360,
                                          CompoundingFrequency.NACA, DayCountConvention.ACT_360)
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACA, DayCountConvention.ACT_365,
                                          CompoundingFrequency.NACA, DayCountConvention.ACT_360)
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACS, DayCountConvention.ACT_365,
                                          CompoundingFrequency.NACM, DayCountConvention.ACT_360)
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACW, DayCountConvention.ACT_365,
                                          CompoundingFrequency.NACC, DayCountConvention.ACT_360)
        ...
        rate = RateUtility.equivalentRate(0.05, CompoundingFrequency.NACC, DayCountConvention.ACT_365,
    ...
    def test_invalidInputs(self):
        ...
        with self.assertRaises(ValueError):
            RateUtility.equivalentRate(0.05, 'invalid_compounding', DayCountConvention.ACT_360,
                                       CompoundingFrequency.NACA, DayCountConvention.ACT_360)

        # Test with invalid day count convention
        with self.assertRaises(ValueError):
            RateUtility.equivalentRate(0.05, CompoundingFrequency.NACA, 'invalid_day_count',
                                       CompoundingFrequency.NACA, DayCountConvention.ACT_360)
...
class TestDiscountFactor(unittest.TestCase):
    ...
    def test_discountFactor(self):
        ...
        # Test case 1: Annual compounding, ACT/360
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACA, DayCountConvention.ACT_360,
        ...
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACS, DayCountConvention.ACT_360,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951814396476418, places=10)

        # Test case 3: Monthly compounding, ACT/360
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACM, DayCountConvention.ACT_360,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951969721710457, places=10)

        # Test case 4: Continuous compounding, ACT/360
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACC, DayCountConvention.ACT_360,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951229424500714, places=10)

        # Test case 5: Daily compounding, ACT/360
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACD, DayCountConvention.ACT_360,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951230271715037, places=10)

        # Test case 6: Annual compounding, ACT/365
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACA, DayCountConvention.ACT_365,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951229424500714, places=10)

        # Test case 7: Semi-annual compounding, ACT/365
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACS, DayCountConvention.ACT_365,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951814396476418, places=10)

        # Test case 8: Monthly compounding, ACT/365
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACM, DayCountConvention.ACT_365,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951969721710457, places=10)

        # Test case 9: Continuous compounding, ACT/365
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACC, DayCountConvention.ACT_365,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951229424500714, places=10)

        # Test case 10: Daily compounding, ACT/365
        df = RateUtility.discountFactor(0.05, CompoundingFrequency.NACD, DayCountConvention.ACT_365,
                                        date(2023, 1, 1), date(2024, 1, 1))
        self.assertAlmostEqual(df, 0.951230271715037, places=10)
    ...
    def test_invalidInputsDiscountFactor(self):
        ...
        # Test with invalid compounding frequency
        with self.assertRaises(ValueError):
            RateUtility.discountFactor(0.05, 'invalid_compounding', DayCountConvention.ACT_360,
                                       date(2023, 1, 1), date(2024, 1, 1))

        # Test with invalid day count convention
        with self.assertRaises(ValueError):
            RateUtility.discountFactor(0.05, CompoundingFrequency.NACA, 'invalid_day_count',
                                       date(2023, 1, 1), date(2024, 1, 1))
